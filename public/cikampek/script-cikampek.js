...
function formatTanggal(tanggal) {
    ...
    // Fetch data for Rekap Data K3 cikampek
    fetch('http://localhost:3000/getdatacikampek')
    ...
    fetch('http://localhost:3000/getpersonelcikampek')
        .then(response => response.json())
        .then(data => {
            if (data.message === 'Data Found') {
...
// Fetch data for Personel K3
fetch('http://localhost:3000/getkecelakaancikampek')
    .then(response => response.json())
    .then(data => {
        if (data.message === 'Data Found') {
    ...
    .catch(error => console.error('Error fetching Personel K3 data:', error));
            ...
            // Fetch data for Personel K3
    fetch('http://localhost:3000/getkejadiancikampek')
        .then(response => response.json())
        .then(data => {
            if (data.message === 'Data Found') {
        ...
        .catch(error => console.error('Error fetching Personel K3 data:', error));
                    ...
                    // Fetch data for Personel K3
    fetch('http://localhost:3000/getstrukturcikampek')
    .then(response => response.json())
    .then(data => {
        if (data.message === 'Data Found') {
